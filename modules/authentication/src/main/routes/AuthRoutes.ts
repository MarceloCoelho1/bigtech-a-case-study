...
import { roleMiddleware } from '../../presentation/middlwares/roleMiddleware';
...
export const authRouter = (app: FastifyInstance): void => {
  ...
  app.get('/auth/admin', {preHandler: [roleMiddleware]}, adaptAuthRoute(authController, 'accessByAdmin'))
} 